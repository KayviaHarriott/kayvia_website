...
export const AboutMe = (): JSX.Element => {
   ...
   * @type {string}
   */
  const paragraph1: string = `Hi, my name is Kayvia! I was born and raised in Jamaica 
   ...
   * @type {string}
   */
  const paragraph3: string = `As I grew older, I gravitated towards technology excelling in my computer classes the most. And ofcourse
   ...
   * @type {string}
   */
  const paragraph2: string = `In my free time, I'm an aspiring loner and gamer. I love to play problem solving games, while also taking time to be
  ...
  return (
    <>
      <Box>
        ...
        <Box>
          <div className="float-left pr-6 pb-2 pt-4">
            <PhotoCard
              photo={photo1}
              title="baby photo of me :)"
              alt="Old photo of Kayvia looking at camera in pink dress"
            />
          </div>
          <p className="text-base">{paragraph1}</p>
          <p className="pt-2 text-base">{paragraph2}</p>
        </Box>
        <Box className="pt-4">
          <div className="float-right pl-6 pb-2 pt-4">
            <PhotoCard
              photo={photo2}
              title="graduation '23"
              alt="Graduation photo of Kayvia and friend"
            />
          </div>
          <p className="pt-2 text-base">{paragraph3}</p>
        </Box>
        <Box className="pt-4">
          <CustomButton
            title="Lorem"
            variant="contained"
            stylePreferences={{ width: "100%" }}
          />
        </Box>
      </Box>
    </>
